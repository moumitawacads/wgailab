...
@section('content')
    ...
    <h1 class="h3 mb-3"><strong>Business Plan</strong> List</h1>
    ...
    <div class="row">
        <div class="mb-3">
            <a href="{{route('admin.businessplan.create')}}"><button class="dom-primary-btn float-end"><i class="align-middle me-2" data-feather="plus"></i>Add Business Plan</button></a>
        </div>
            ...
            <form method="GET" class="row filter-form-wrap">
                ...
                <div class="col-md-2">
                    <div class="filter-btn-area">
                        ...
                        <a href="{{ route('admin.businessplan') }}" class="back-btn">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="d-md-table-cell" >
                                <div class="action-wrapper">
                                    <a href="{{ route('admin.businessplan.edit', $item->id) }}"><button class="bg-black btn-sm"><i class="align-middle me-1" data-feather="edit"></i> <span class="align-middle"></span></button></a>
                                
                                    @if(count($item->sessionLinks) == 0)
                                        <form class="d-inline" action="{{ route('admin.businessplan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
